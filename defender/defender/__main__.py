...
try:
    ...
    HAS_EMBER_MODEL = True
except ImportError as e:
    print(f"Warning: Could not import EmberModel: {e}")
    HAS_EMBER_MODEL = False
...
if __name__ == "__main__":
    ...
    elif model_name.lower() == "ember" and HAS_EMBER_MODEL:
        try:
            print("Loading EmberModel")
            # EmberModel uses default path from ember_model.py
            model = EmberModel(thresh=model_thresh)
            print("EmberModel loaded successfully")
        except Exception as e:
